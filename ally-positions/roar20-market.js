/* =============================================================================
 * ally-positions/roar20-market.js 1.0.0 (2026-09-26) — ROAR20's MARKET, captured server-side every hour.
 * -----------------------------------------------------------------------------
...
async function run(o) {
  ...
  const tries = [['DexScreener', dexscreener], ['GeckoTerminal', geckoterminal], ['Jupiter', jupiter]];
...
module.exports = { VERSION, run, dexscreener, geckoterminal, jupiter, fromHistory };
