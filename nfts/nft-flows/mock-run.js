...
const LUNA_HITS = [];   // 1.1.2: the exact path the cron asks for — the 404 of 2026-09-13 was a right suffix on the wrong repo
...
(async () => {
  ...
  ok(J('pixel-lions/nft-flows/heartbeat.json').version === '1.1.2' && J('pixel-lions/nft-flows/heartbeat.json').status === 'ok', 'heartbeat 1.1.2 ok');
