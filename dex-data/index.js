...
const VERSION = 'dex-data-1.4.3';   // 1.4.3 (2026-09-20): eris-apr prices emissions at the LIVE LUNA (network-and-prices) before the token-catalog day price — the adapters never carry uluna, and the day price read −14.8 % vs Eris on a 19 % day; formula untouched, source + as-of published (lib/eris-apr.js).
