...
const VERSION = 'dex-data-1.4.4';   // 1.4.4 (2026-09-21): epochs-skeletonswap prices pool assets by DENOM first (network-and-prices 3.1.0 keys the stables by the catalog symbol; SS spells them USDC / USDt / EURe) · 1.4.3 (2026-09-20): eris-apr prices emissions at the LIVE LUNA (network-and-prices) before the token-catalog day price — the adapters never carry uluna, and the day price read −14.8 % vs Eris on a 19 % day; formula untouched, source + as-of published (lib/eris-apr.js).
// 1.4.2:   // 1.4.2 (2026-09-14): state-history samples live after the boundary on the public node (asking a pruned node for the past gave 50/67 depth on epoch 203); schedule moved to :01 · 1.4.1 (2026-09-14): state-history folds event months one at a time (1.4.0 held all 273 MB → heap OOM on the first boundary run, and eris-apr — later in the same process — stopped with it) · 1.4.0 (2026-09-13): state-history duty folded in (lib/state-history.js, moved from the tla-core Action — one epoch a week from the PUBLIC LCD; the archive was backfill-only) · 1.3.5: eris-apr meta.validation → reconciled 2026-09-10; Credia rows named from the catalog receipt symbol (wBTC.creda.a) · 1.3.4: eris-apr trading leg source-verbatim (single gauges = own yield: xASTRO tRPC stakingApy, ampCAPA hub exchange_rates apr, Credia supply_apy; SS = 0 by source) · 1.3.3: eris-apr staked basis for SkeletonSwap (reserve-implied TVL × catalog prices) + Credia (receipt supply) + single names; catalog decimals fix — audit 2026-09-10 vs Eris screen · 1.3.2: Credia rate-history sidecar (lib/credia-rates.js) — hourly indexer points kept grow-only, 7-day ranges in rates/current.json
